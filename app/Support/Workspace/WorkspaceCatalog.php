...
class WorkspaceCatalog
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'reports.customers' => ['type' => 'reports', 'title' => 'Customer Directory', 'closable' => true],
            'reports.inventory' => ['type' => 'reports', 'title' => 'Inventory Stock', 'closable' => true],
            'reports.sales-by-item' => ['type' => 'reports', 'title' => 'Sales by Item', 'closable' => true],
