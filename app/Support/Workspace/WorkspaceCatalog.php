...
class WorkspaceCatalog
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            'customers.statements' => ['type' => 'customers', 'title' => 'Create Statements', 'closable' => true],
            ...
            'sales-orders.edit' => ['type' => 'sales-order-form', 'title' => 'Edit Sales Order', 'closable' => true],
            ...
            'invoices.edit' => ['type' => 'invoice-form', 'title' => 'Edit Invoice', 'closable' => true],
            ...
            'purchase-orders.edit' => ['type' => 'purchase-order-form', 'title' => 'Edit Purchase Order', 'closable' => true],
            ...
            'goods-receipts.edit' => ['type' => 'goods-receipt-form', 'title' => 'Edit Receive Inventory', 'closable' => true],
            ...
            'vendor-bills.edit' => ['type' => 'vendor-bill-form', 'title' => 'Edit Bill', 'closable' => true],
            'vendor-returns.create' => ['type' => 'vendor-rtv-form', 'title' => 'Return to Vendor (RTV)', 'closable' => true],
            'vendor-returns.edit' => ['type' => 'vendor-rtv-form', 'title' => 'Edit RTV', 'closable' => true],
            ...
            'users.index' => ['type' => 'users', 'title' => 'Users', 'closable' => true],
            'users.create' => ['type' => 'user-form', 'title' => 'Create User', 'closable' => true],
            'users.edit' => ['type' => 'user-form', 'title' => 'Edit User', 'closable' => true],
            'roles.index' => ['type' => 'roles', 'title' => 'Roles', 'closable' => true],
            'roles.create' => ['type' => 'role-form', 'title' => 'Create Role', 'closable' => true],
            'roles.edit' => ['type' => 'role-form', 'title' => 'Edit Role', 'closable' => true],
