...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.document-ribbon','data' => ['findRouteName' => 'credit-memos.index','newRouteName' => 'credit-memos.create','activeTab' => $ribbonTab,'isPending' => $is_pending,'showApplyCredits' => true,'showReceivePayments' => false,'showRefundCredit' => true,'applyCreditsRouteName' => 'credit-memos.index','refundCreditRouteName' => 'credit-memos.create','attachmentCount' => count($pendingAttachments),'formattingFontSize' => $formattingFontSize,'formattingBold' => $formattingBold]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['find-route-name' => 'credit-memos.index','new-route-name' => 'credit-memos.create','active-tab' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ribbonTab),'is-pending' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($is_pending),'show-apply-credits' => true,'show-receive-payments' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'show-refund-credit' => true,'apply-credits-route-name' => 'credit-memos.index','refund-credit-route-name' => 'credit-memos.create','attachment-count' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(count($pendingAttachments)),'formatting-font-size' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formattingFontSize),'formatting-bold' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($formattingBold)]); ?>
                ...
                <div class="be-invoice-midrow be-credit-midrow">
                    ...
                    <div class="be-invoice-midrow__right">
                        <div class="be-field be-field--inline">
                            ...
                            <?php if (isset($component)) { $__componentOriginal5ffc033813591e85e4508e27a2ee1612 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5ffc033813591e85e4508e27a2ee1612 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.input','data' => ['type' => 'date','wire:model' => 'credit_date','class' => 'be-input--combo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('erp.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'date','wire:model' => 'credit_date','class' => 'be-input--combo']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5ffc033813591e85e4508e27a2ee1612)): ?>
<?php $attributes = $__attributesOriginal5ffc033813591e85e4508e27a2ee1612; ?>
...
<?php endif; ?>
                        ...
                        <div class="be-field be-field--inline">
                            ...
                            <?php if (isset($component)) { $__componentOriginal5ffc033813591e85e4508e27a2ee1612 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5ffc033813591e85e4508e27a2ee1612 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.input','data' => ['wire:model' => 'credit_number','class' => 'be-input--combo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('erp.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'credit_number','class' => 'be-input--combo']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5ffc033813591e85e4508e27a2ee1612)): ?>
<?php $attributes = $__attributesOriginal5ffc033813591e85e4508e27a2ee1612; ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['credit_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="be-field__error"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="be-field be-field--inline">
                            ...
                            <?php if (isset($component)) { $__componentOriginal5ffc033813591e85e4508e27a2ee1612 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5ffc033813591e85e4508e27a2ee1612 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.input','data' => ['wire:model' => 'po_number','class' => 'be-input--combo']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('erp.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'po_number','class' => 'be-input--combo']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5ffc033813591e85e4508e27a2ee1612)): ?>
<?php $attributes = $__attributesOriginal5ffc033813591e85e4508e27a2ee1612; ?>
                    ...
                    <table class="be-table be-invoice-grid">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr wire:key="cm-line-<?php echo e($index); ?>" class="<?php echo e($index % 2 ? 'be-row-alt' : ''); ?>">
                                    <td>
                                        <?php if (isset($component)) { $__componentOriginal847fd48de2d422593186c84a70c7291b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal847fd48de2d422593186c84a70c7291b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.select','data' => ['wire:model.live' => 'lines.'.e($index).'.item_id','options' => ['' => ''] + $itemOptions,'class' => 'be-input--bare']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('erp.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'lines.'.e($index).'.item_id','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['' => ''] + $itemOptions),'class' => 'be-input--bare']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal847fd48de2d422593186c84a70c7291b)): ?>
<?php $attributes = $__attributesOriginal847fd48de2d422593186c84a70c7291b; ?>
            ...
            <aside class="be-invoice-inspector">
                ...
                <?php elseif($selectedCustomer): ?>
                    ...
                    <div class="be-inspector-section">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentCredits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="be-inspector-txn">
                                <span><?php echo e($cm->credit_date?->format('m/d/y')); ?> Credit</span>
                                <span class="be-inspector-txn__amt"><?php echo e(number_format((float) $cm->total, 2)); ?></span>
                            </div>
...
</div><?php /**PATH F:\laragon\www\bargain-enterprise\resources\views\livewire\sales\credit-memo-form.blade.php ENDPATH**/ ?>