...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.list-toolbar','data' => ['heading' => 'Credit Memo List','newRoute' => 'credit-memos.create','newLabel' => 'New Credit Memo','title' => $memos->total().' credit memos']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Credit Memo List','new-route' => 'credit-memos.create','new-label' => 'New Credit Memo','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($memos->total().' credit memos')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.look-for','data' => ['placeholder' => 'Credit memo # / customer…']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Credit memo # / customer…']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <table class="be-table be-table--line-select">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $memos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $memo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr
                            wire:key="cm-<?php echo e($memo->id); ?>"
                            wire:click="selectLine(<?php echo e($memo->id); ?>)"
                            class="<?php echo e($selectedLineId === $memo->id ? 'is-selected' : ''); ?>"
                        >
                            <td><?php echo e($memo->credit_date?->format('m/d/Y')); ?></td>
                            <td><?php echo e($memo->credit_number); ?></td>
                            <td><?php echo e($memo->customer?->display_name); ?></td>
                            <td><span class="be-badge"><?php echo e($memo->status); ?></span></td>
                            <td class="num"><?php echo e($memo->lines_count); ?></td>
                            <td class="num"><?php echo e(number_format((float) $memo->total, 2)); ?></td>
                            <td class="num"><?php echo e(number_format((float) $memo->remaining_credit, 2)); ?></td>
                            <td class="whitespace-nowrap">
                                <a href="<?php echo e(route('credit-memos.pdf', $memo)); ?>" class="be-link-btn" target="_blank" @click.stop>PDF</a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($memo->hasRemainingCredit()): ?>
                                    <a href="<?php echo e(route('credit-memos.apply', $memo)); ?>" class="be-link-btn" @click.stop>Apply / Refund</a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.empty-state','data' => ['title' => 'No credit memos']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No credit memos']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.pagination','data' => ['paginator' => $memos]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($memos)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH F:\laragon\www\bargain-enterprise\resources\views\livewire\sales\credit-memo-index.blade.php ENDPATH**/ ?>