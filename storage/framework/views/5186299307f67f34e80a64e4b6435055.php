...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.select','data' => ['wire:model.live' => 'role','options' => $roleOptions]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'role','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($roleOptions)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="flex flex-wrap items-center gap-2">
                <button type="button" class="be-btn" wire:click="resetToRole" <?php if($role === ''): echo 'disabled'; endif; ?>>Reset to role defaults</button>
                ...
                <span class="text-[11px] text-gray-500"><?php echo e(count($selectedPermissions)); ?> permission(s) for this user</span>
            </div>
            ...
            <div class="space-y-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <div class="be-panel" wire:key="user-menu-<?php echo e($menu); ?>">
                        <div class="be-panel__body space-y-3">
                            ...
                            <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $section['submenus']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submenu => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div class="rounded border border-gray-200 p-2" wire:key="user-sub-<?php echo e($menu); ?>-<?php echo e($submenu); ?>">
                                                ...
                                                <label class="flex cursor-pointer items-start gap-2 text-[12px]">
                                                    ...
                                                    <span>
                                                        <span class="block">
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fromRole && ! $checked): ?>
                                                                <span class="text-[10px] text-amber-700">(removed from role)</span>
                                                            <?php elseif(! $fromRole && $checked): ?>
