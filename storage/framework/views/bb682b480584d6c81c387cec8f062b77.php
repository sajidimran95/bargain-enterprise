...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.list-toolbar','data' => ['heading' => 'Bank Accounts','newRoute' => 'banking.create','newLabel' => 'New Account','title' => $accounts->total().' bank accounts']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Bank Accounts','new-route' => 'banking.create','new-label' => 'New Account','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($accounts->total().' bank accounts')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.look-for','data' => ['placeholder' => 'Bank / GL account…']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Bank / GL account…']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <table class="be-table be-table--line-select">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr
                            wire:key="bank-<?php echo e($bank->id); ?>"
                            wire:click="selectLine(<?php echo e($bank->id); ?>)"
                            class="<?php echo e($selectedLineId === $bank->id ? 'is-selected' : ''); ?>"
                        >
                            <td><?php echo e($bank->name); ?></td>
                            <td><?php echo e($bank->bank_name); ?></td>
                            <td><?php echo e($bank->account?->number); ?></td>
                            <td><?php echo e($bank->account?->name); ?></td>
                            <td><?php echo e($bank->account_number_mask); ?></td>
                            <td class="num"><?php echo e(number_format((float) $bank->opening_balance, 2)); ?></td>
                            <td><?php echo e($bank->is_active ? 'Yes' : 'No'); ?></td>
                        </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.empty-state','data' => ['title' => 'No bank accounts']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No bank accounts']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH F:\laragon\www\bargain-enterprise\resources\views\livewire\banking\banking-index.blade.php ENDPATH**/ ?>