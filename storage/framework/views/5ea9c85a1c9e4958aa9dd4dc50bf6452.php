...
<div <?php echo e($attributes->class(['be-tabs'])); ?>>
    <div class="be-tabs__list" role="tablist">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button
                type="button"
                role="tab"
                class="be-tabs__tab <?php echo e($active === $key ? 'is-active' : ''); ?>"
                wire:click="$set('activeTab', '<?php echo e($key); ?>')"
                aria-selected="<?php echo e($active === $key ? 'true' : 'false'); ?>"
            >
                <?php echo e($label); ?>
...
<?php /**PATH F:\laragon\www\bargain-enterprise\resources\views/components/erp/tabs.blade.php ENDPATH**/ ?>