...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.list-toolbar','data' => ['heading' => 'Receive Inventory','newRoute' => 'goods-receipts.create','newLabel' => 'Receive Inventory','title' => $receipts->total().' receipts']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Receive Inventory','new-route' => 'goods-receipts.create','new-label' => 'Receive Inventory','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($receipts->total().' receipts')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.look-for','data' => ['placeholder' => 'Receipt # / vendor / memo…']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Receipt # / vendor / memo…']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No goods receipts']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH F:\laragon\www\bargain-enterprise\resources\views\livewire\purchasing\goods-receipt-index.blade.php ENDPATH**/ ?>