                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            >
                                ...
                                <td class="num <?php echo e((float) $item->on_hand < 0 ? 'text-red-700' : ''); ?>">
                                    <?php echo e(number_format((float) $item->on_hand, 2)); ?>
                ...
                <div class="flex items-center justify-between border-b px-2 py-1" style="border-color: var(--be-border); background: #ececec;">
                    ...
                    <div class="flex items-center gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selected): ?>
                            <?php if (isset($component)) { $__componentOriginal5abd15ccddcad372df58dab78ed00d60 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5abd15ccddcad372df58dab78ed00d60 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.workspace-link','data' => ['route' => 'items.edit','params' => ['item' => $selected->id],'class' => 'be-link-btn text-[11px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('erp.workspace-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => 'items.edit','params' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['item' => $selected->id]),'class' => 'be-link-btn text-[11px]']); ?>Open item <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5abd15ccddcad372df58dab78ed00d60)): ?>
<?php $attributes = $__attributesOriginal5abd15ccddcad372df58dab78ed00d60; ?>
<?php unset($__attributesOriginal5abd15ccddcad372df58dab78ed00d60); ?>
...
<?php endif; ?>
                        ...
                        <button type="button" class="be-link-btn text-[11px]" wire:click="toggleActivity">
                            <?php echo e($showActivity ? 'Hide' : 'Show'); ?>

                        </button>
                    </div>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showActivity): ?>
                    <div class="be-datatable-wrap" style="max-height: 180px;">
                        <table class="be-table">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $activity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr wire:key="list-hist-<?php echo e($row->id); ?>">
                                        <td class="whitespace-nowrap text-[11px]"><?php echo e($row->occurred_at?->format('m/d/y g:i A')); ?></td>
                                        <td class="text-[11px]"><?php echo e($row->label()); ?></td>
                                        <td class="num"><?php echo e(bccomp((string) $row->qty_in, '0', 4) > 0 ? number_format((float) $row->qty_in, 2) : ''); ?></td>
                                        <td class="num"><?php echo e(bccomp((string) $row->qty_out, '0', 4) > 0 ? number_format((float) $row->qty_out, 2) : ''); ?></td>
                                        <td class="num"><?php echo e($row->balance_after !== null ? number_format((float) $row->balance_after, 2) : ''); ?></td>
                                        <td class="num"><?php echo e($row->old_value !== null ? number_format((float) $row->old_value, 2) : ''); ?></td>
                                        <td class="num"><?php echo e($row->new_value !== null ? number_format((float) $row->new_value, 2) : ''); ?></td>
                                        <td class="text-[11px]"><?php echo e($row->memo); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
...
<?php /**PATH F:\laragon\www\bargain-enterprise\resources\views/livewire/items/item-list.blade.php ENDPATH**/ ?>