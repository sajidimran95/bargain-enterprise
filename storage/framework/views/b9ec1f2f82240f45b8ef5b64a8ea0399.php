...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.list-toolbar','data' => ['heading' => 'Check List','newRoute' => 'checks.create','newLabel' => 'Write Checks','title' => $checks->total().' checks']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Check List','new-route' => 'checks.create','new-label' => 'Write Checks','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($checks->total().' checks')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.look-for','data' => ['placeholder' => 'Check # / payee…']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Check # / payee…']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <table class="be-table be-table--line-select">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $checks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr
                            wire:key="chk-<?php echo e($check->id); ?>"
                            wire:click="selectLine(<?php echo e($check->id); ?>)"
                            class="<?php echo e($selectedLineId === $check->id ? 'is-selected' : ''); ?>"
                        >
                            <td><?php echo e($check->check_date?->format('m/d/Y')); ?></td>
                            <td><?php echo e($check->check_number); ?></td>
                            <td><?php echo e($check->bankAccount?->name); ?></td>
                            <td><?php echo e($check->payee ?: $check->vendor?->display_name); ?></td>
                            <td class="num"><?php echo e(number_format((float) $check->amount, 2)); ?></td>
                            <td><?php echo e($check->memo); ?></td>
                        </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.empty-state','data' => ['title' => 'No checks']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No checks']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.pagination','data' => ['paginator' => $checks]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($checks)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH F:\laragon\www\bargain-enterprise\resources\views\livewire\banking\check-index.blade.php ENDPATH**/ ?>