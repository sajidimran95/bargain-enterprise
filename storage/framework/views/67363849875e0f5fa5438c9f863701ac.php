...
<div <?php echo e($attributes->class('be-look-for')); ?>>
    <div class="be-field">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.input','data' => ['xRef' => 'listSearch','wire:model.live.debounce.300ms' => ''.e($searchModel).'','placeholder' => $placeholder,'class' => 'w-56']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-ref' => 'listSearch','wire:model.live.debounce.300ms' => ''.e($searchModel).'','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($placeholder),'class' => 'w-56']); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($withinModel && $withinOptions !== []): ?>
        <div class="be-field">
            <label class="be-field__label"><?php echo e($withinLabel ?? 'Search within'); ?></label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.select','data' => ['wire:model.live' => ''.e($withinModel).'','options' => $withinOptions]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => ''.e($withinModel).'','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($withinOptions)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH F:\laragon\www\bargain-enterprise\resources\views/components/erp/look-for.blade.php ENDPATH**/ ?>