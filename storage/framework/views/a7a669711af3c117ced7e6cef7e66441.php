...
<div <?php echo e($attributes->class(['be-page-header'])); ?>>
    <div>
        <h1 class="be-page-header__title"><?php echo e($title); ?></h1>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subtitle): ?>
            <p class="be-page-header__subtitle"><?php echo e($subtitle); ?></p>
...
<?php /**PATH F:\laragon\www\bargain-enterprise\resources\views\components\erp\page-header.blade.php ENDPATH**/ ?>