...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.list-toolbar','data' => ['heading' => 'Deposit List','newRoute' => 'deposits.create','newLabel' => 'Record Deposit','title' => $deposits->total().' deposits']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Deposit List','new-route' => 'deposits.create','new-label' => 'Record Deposit','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($deposits->total().' deposits')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.look-for','data' => ['placeholder' => 'Deposit # / bank…']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Deposit # / bank…']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <table class="be-table be-table--line-select">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr
                            wire:key="dep-<?php echo e($deposit->id); ?>"
                            wire:click="selectLine(<?php echo e($deposit->id); ?>)"
                            class="<?php echo e($selectedLineId === $deposit->id ? 'is-selected' : ''); ?>"
                        >
                            <td><?php echo e($deposit->deposit_date?->format('m/d/Y')); ?></td>
                            <td><?php echo e($deposit->number); ?></td>
                            <td><?php echo e($deposit->bankAccount?->name); ?></td>
                            <td class="num"><?php echo e($deposit->items_count); ?></td>
                            <td class="num"><?php echo e(number_format((float) $deposit->total, 2)); ?></td>
                            <td><?php echo e($deposit->memo); ?></td>
                        </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.empty-state','data' => ['title' => 'No deposits']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No deposits']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.pagination','data' => ['paginator' => $deposits]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($deposits)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH F:\laragon\www\bargain-enterprise\resources\views\livewire\banking\deposit-index.blade.php ENDPATH**/ ?>