...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.list-toolbar','data' => ['heading' => 'Role List','newRoute' => 'roles.create','newLabel' => 'New Role','title' => $roles->total().' roles']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'Role List','new-route' => 'roles.create','new-label' => 'New Role','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($roles->total().' roles')]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.look-for','data' => ['placeholder' => 'Role name…']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Role name…']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <table class="be-table be-table--line-select">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr
                            wire:key="role-<?php echo e($role->id); ?>"
                            wire:click="selectLine(<?php echo e($role->id); ?>)"
                            wire:dblclick="openEdit(<?php echo e($role->id); ?>)"
                            class="<?php echo e($selectedLineId === $role->id ? 'is-selected' : ''); ?> cursor-pointer"
                        >
                            <td><?php echo e($role->label); ?></td>
                            <td><code class="text-[11px]"><?php echo e($role->name); ?></code></td>
                            <td><?php echo e($role->description); ?></td>
                            <td class="num"><?php echo e($role->users_count); ?></td>
                            <td class="num"><?php echo e($role->permissions_count); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.workspace-link','data' => ['route' => 'roles.edit','params' => ['role' => $role->id],'title' => 'Role: '.$role->label,'class' => 'be-link-btn','@click.stop' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => 'roles.edit','params' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['role' => $role->id]),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Role: '.$role->label),'class' => 'be-link-btn','@click.stop' => true]); ?>Edit <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.empty-state','data' => ['title' => 'No roles']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'No roles']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.pagination','data' => ['paginator' => $roles]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH F:\laragon\www\bargain-enterprise\resources\views/livewire/roles/role-index.blade.php ENDPATH**/ ?>